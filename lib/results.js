...
/**
 * Generates a group table for a given group of players.
 */
function generateGroupTableLeague(groupData, seasonNumber, weekNumber, isPreseason, playerArgs, dataVods) {
  ...
  return toMwTemplate('GroupTableLeague', {...groupArgs, ...playerArgs})
}

/**
 * Generates a single box representing the results of one group's matches.
 */
function generateGroupBox(groupData, seasonNumber, weekNumber, isPreseason, dataVods) {
  ...
  const groupTpl = generateGroupTableLeague(groupData, seasonNumber, weekNumber, isPreseason, playerArgs, dataVods)
